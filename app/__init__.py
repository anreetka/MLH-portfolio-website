...
def index():
    ...
    work_experiences=[
            ...
            {'company': 'MLH Fellowship', 'position': 'Production Engineering Fellow w/ Meta', 'duration': 'Jun 2024 - Present', 'description': 'Received acceptance into highly selective (acceptance rate < 2.5%) Production Engineering program sponsored by Meta'},
